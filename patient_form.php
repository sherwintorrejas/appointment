    ...
    <div class="container">
        ...
        <?php if ($editMode): ?>
            ...
            <form action="patient_form.php" method="post">
                ...
                <a href="patient_form.php" class="button" style="   font-size: 13px; background-color: #8d0a0a; color: white; padding: 8px 14px; border: none; border-radius: 4px; cursor: pointer;"> Back </a> 
